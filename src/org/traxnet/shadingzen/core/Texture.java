...
public class Texture extends Resource {
	...
	boolean loadAsTexture2D(Context context, String id, int resource_id, Texture.Parameters params){
		_bmps = new Bitmap[1];
	...
	boolean loadAsTextureCubeMap(Context context, String id, int resource_id, Texture.Parameters params){
		_bmps  = new Bitmap[6];
		Matrix flip = new Matrix();
	    flip.postScale(1f, -1f);
	...
	public boolean onStorageLoad(Context context, String id, int resource_id, Object params) {
		try{
			if(null != params){
				Texture.Parameters texparams = (Texture.Parameters)params;
			...
			return loadAsTexture2D(context, id, resource_id, new Texture.Parameters());
		} catch(Exception e){
			return false;
		}
	}
