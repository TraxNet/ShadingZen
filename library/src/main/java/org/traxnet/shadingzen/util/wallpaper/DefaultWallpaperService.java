...
import org.traxnet.shadingzen.util.wallpaper.EGLConfigChooser;
import org.traxnet.shadingzen.util.wallpaper.EGLContextFactory;
import org.traxnet.shadingzen.util.wallpaper.GLWallpaperService;

import android.util.Log;

public abstract class DefaultWallpaperService extends GLWallpaperService {
	protected static String TAG = "DefaultWallpaperService";
	protected static final boolean DEBUG = false;

	protected static class ContextFactory implements EGLContextFactory {
